...
const SOURCE_SNIPPET = `// src/entry.server.ts — Rsbuild's SSR entry
...
<body>
    <main class="demo">
        <article class="demo__card">
            ...
            <p class="demo__message">Server-side rendered by Esmx on Rsbuild. The client entry hydrates this page in place.</p>
            ...
            <div id="app"></div>
            <p class="demo__source">source · <code>examples/ssr-rsbuild-html/src/entry.server.ts</code></p>
        </article>
    </main>
    ${rc.importmap()}
    ${rc.moduleEntry()}
