...
description: A quick start guide for the Esmx framework, helping you set up a project from scratch, including project initialization, framework version selection, and AI-assisted development.
head:
  - - meta
    - name: keywords
...
The Esmx framework offers multiple technology stack versions, each optimized for different application scenarios. Choose the appropriate version based on your project requirements:
...
The Esmx framework provides AI-assisted development capabilities to significantly enhance development efficiency:
