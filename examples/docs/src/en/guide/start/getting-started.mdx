---
titleSuffix: "Creating Your First Application"
...
| **vue-ssr** | Vue 3 SSR |
| **react-csr** | React 18+ CSR |
| **react-ssr** | React 18+ SSR |
...
- [Rspack](/guide/essentials/rspack) — configure and extend the build
- [Render Context](/guide/essentials/render-context) — control SSR rendering and resource injection
- [Router Introduction](/guide/router/introduction) — add framework-agnostic routing
