...
| 模板 | 描述 |
|------|------|
| **shared-modules** | 用于创建跨项目共享的微前端模块 |
| **vue-csr** | Vue 3 客户端渲染 |
| **vue-ssr** | Vue 3 SSR |
| **react-csr** | React 18+ 客户端渲染 |
| **react-ssr** | React 18+ SSR |
| **vue2-csr** | Vue 2.7 客户端渲染 |
| **vue2-ssr** | Vue 2.7 SSR |
...
- [Rspack](/zh/guide/essentials/rspack) —— 配置与扩展构建
- [渲染上下文](/zh/guide/essentials/render-context) —— 控制 SSR 渲染与资源注入
- [路由介绍](/zh/guide/router/introduction) —— 加入框架无关的路由
