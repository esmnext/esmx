---
titleSuffix: Gez 框架 Vue3 SSR 应用示例
description: 从零开始搭建基于 Gez 的 Vue3 SSR 应用，通过实例展示框架的基本用法，包括项目初始化、Vue3 配置和入口文件设置。
head:
  - - meta
    - property: keywords
      content: Gez, Vue3, SSR应用, TypeScript配置, 项目初始化, 服务端渲染, 客户端交互, 组合式API
---

# Vue3

本教程将帮助你从零开始搭建一个基于 Gez 的 Vue3 SSR 应用。我们将通过一个完整的示例来展示如何使用 Gez 框架创建服务端渲染应用。
...
<template>
    <div>
        <h1><a href="https://www.esmnext.com/guide/frameworks/vue3.html" target="_blank">Gez 快速开始</a></h1>
...
现在，你已经成功创建了一个基于 Gez 的 Vue3 SSR 应用！访问 http://localhost:3000 即可看到效果。
