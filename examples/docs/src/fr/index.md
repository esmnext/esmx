...
description: Esmx est un framework de rendu côté serveur haute performance basé sur ESM, offrant des capacités complètes de SSR, un contexte de rendu intelligent et un système innovant de liaison de modules, adapté au développement d'applications Web de grande envergure.
head:
  - - meta
    - property: keywords
      content: Esmx, SSR, ESM, rendu côté serveur, liaison de modules, Vue, React, TypeScript, micro-frontend
hero:
  name: Esmx
  text: Framework de rendu côté serveur basé sur ESM
  tagline: Système de liaison de modules haute performance et extensible
  actions:
    - theme: brand
...
features:
  - icon: ⚡️
    ...
    details: Moteur SSR haute performance basé sur ESM Import Maps, prenant en charge les frameworks populaires comme Vue et React, offrant des capacités complètes de rendu côté serveur.
  - icon: 🎯
    title: Contexte de rendu
    details: Système intelligent de RenderContext, fournissant une injection précise des ressources, une synchronisation des états et un mécanisme d'activation côté client, garantissant des performances de rendu optimales.
  - icon: 🔗
    title: Liaison de modules
  ...
  - icon: 🛠️
    title: Expérience de développement
