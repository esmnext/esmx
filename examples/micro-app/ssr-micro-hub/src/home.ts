...
export function createHomeApp(router: Router): RouterMicroAppOptions {
    ...
    return {
        mount(el: HTMLElement) {
            ...
            container.style.cssText = 'animation: fadeIn 0.4s ease-out;';
            ...
            container.innerHTML = heroSection + cardsSection + featuresSection;
        ...
        renderToString() {
            // Layout handles the shell, this just returns content
            return '';
        }
    };
}
