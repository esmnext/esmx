...
describe('options.ts - Browser Environment Tests', () => {
    ...
    describe('parsedOptions in browser environment', () => {
        ...
        it('should set default empty object for data property', async () => {
            const router = createRouter({});
            expect(router.parsedOptions.data).toEqual({});
            router.destroy();
        });

        it('should use provided data object when specified', async () => {
        ...
        it('should access data property through router instance', async () => {
        ...
        it('should handle data with symbol keys', async () => {
