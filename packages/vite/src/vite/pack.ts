 ...
 * so the artifact can be consumed as a linked module by other esmx apps.
 *
 * This mirrors the subset of @esmx/rspack's pack() that runs when tarball
 * packaging is disabled (the default): it only emits dist/package.json.
 */
