...
<head>
    ...
    <meta name="description" content="Comprehensive test coverage report for Esmx framework packages. Real-time coverage statistics for statements, branches, functions, and lines across all Esmx modules including core, router, router-vue, and more.">
    ...
    <div class="container">
        <header class="header">
            ...
            <div style="margin-top: 20px; padding: 16px 24px; background: rgba(255,255,255,0.9); border-radius: 12px; font-size: 0.95rem; border: 1px solid rgba(139, 69, 19, 0.2); backdrop-filter: blur(10px); position: relative; z-index: 3;">
                📍 <strong>Live Coverage Reports:</strong> <a href="${config.coverageUrl}" style="color: #8B4513; text-decoration: none; border-bottom: 2px solid #FFA726; font-weight: 600;">${config.coverageUrl}</a>
            </div>
